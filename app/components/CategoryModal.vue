<template>
	<div id="cat-modal" class="ui small modal">
		...
		<div class="header">Add a new category</div>
		<div class="content">
			<form class="ui form">
				<div class="field">
...
<script>
	...
	export default {
		...
		created () {
		  	eventHub.$on('add-category', this.showCatModal)
		},

		beforeDestroy () {
		  	eventHub.$off('add-category', this.showCatModal)
		},
		...
		methods: {
			...
			showCatModal() {
				...
				//console.log('add-category event showing the modal')
			}
		},
